...
class Person extends \Faker\Provider\Person
{
    ...
    /**
     * @see https://www.expatnotes.lu/most-common-names-in-luxembourg/
     * @see https://www.wort.lu/fr/luxembourg/etude-luxembourgeoise-sur-les-noms-de-famille-quels-sont-les-noms-de-famille-les-plus-repandus-au-luxembourg-56efe5861bea9dff8fa74d2a
     */
    ...
    protected static $titleMale = ['Här', 'Här Dr.', 'Här Prof.', 'Här Prof. Dr.'];

    protected static $titleFemale = ['Madame', 'Madame Dr.', 'Madame Prof.', 'Madame Prof. Dr.'];
